...
@SourceType(value = "ZohoCreatorARP", label = "ZohoCreator",uiConfig = "zohocreator-layout.json")
public class ZohoCreatorConf extends AbstractArpConf<ZohoCreatorConf> {
  private static final String ARP_FILENAME = "arp/implementation/zohocreator-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.zohocreator.ZohoCreatorDriver";
